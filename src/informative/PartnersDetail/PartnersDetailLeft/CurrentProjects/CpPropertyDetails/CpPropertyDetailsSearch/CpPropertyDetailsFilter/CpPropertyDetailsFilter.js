...
import CpPropertyDetailsRangeSlider from "./CpPropertyDetailsRangeSlider/CpPropertyDetailsRangeSlider";
...
const CpPropertyDetailsFilter = (props) => {
    return (
        <>
            <Modal
                size="lg"
            ...
            >
                ...
                <Modal.Body>
                    <Form className="profile__form pb-4 row">
                        ...
                        <Col md={6} sm={12}>
                            <CpPropertyDetailsRangeSlider title="range" min="40" max="160" />
                        </Col>
                        <Col md={6} sm={12}>
                            <Form.Group className="mb-4">
...
export default CpPropertyDetailsFilter;