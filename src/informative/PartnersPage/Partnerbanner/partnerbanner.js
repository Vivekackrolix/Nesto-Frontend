        ...
        <div className='row partners-row'>
          <div className='col-lg-6 partners-col-1'>
            <div>
              ...
              <p className='partners-p'>Borem ipsum dolor sit amet conse ctetur adipisicing
                elit sed do eiusmod Eorem ipsum dolor sit amet conse ctetur.</p>
              <Link to='/' className='partners-link'>Contact Us</Link>
            </div>
          </div>
