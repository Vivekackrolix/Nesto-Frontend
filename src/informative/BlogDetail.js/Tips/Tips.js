        ...
        <div className="tips-header">
          <div className="tips-header_box text-center">
            <span className="tips-header_heading">
              Tips to buy your dream home in minutes
            </span>
            <div className="tips_box-1">
              <div>
                <img
                  className="tips_user-img"
                  src="/assets/informative/articleImg4.png"
                  alt="article"
                />
                ...
                <>
                  <div className="d-flex gap-3 align-items-center mt-3">
                    <img
                      ...
                      alt="line"
                    />
                    <li className="tips_box-5-li" data-aos="fade-right">
                      {item.para}
                    </li>
                  </div>
                </>
          ...
          <div className="tips_box-3 mt-5">
            <span className="tips_box-2-span">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque
              ornare pellentesque sollicitudin. Suspendisse potenti. Fusce ex
              risus, iaculis sit amet apien nec, finibus malesuada mi. Proin at
              turpis eget sapien pulvinar luctus. estibulum bibendum pharetra
              lorem eu aliquam. In feugiat placerat risus, ed rutrum neque
              mattis sit amet. Nullam vestibulum ante ac quam tempor, d
              venenatis velit eleifend. Duis id iaculis risus, quis ullamcorper
              augue. Nunc ristique.
            </span>
          </div>
