...
const AgentPDtC = () => {
    ...
    return (
        <>
            <div className='container AgentPDtC' data-aos='fade-up'>
                <span className='PropertyDetails-heading'>Terms & Conditions</span>
                <div className='col-lg-12 AgentPDtC-col'>
                    <span className='AgentPDtC-col_span'>
