...
const BuilderPDtC = () => {
    ...
    return (
        <>
            <div className='container BuilderPDtC' data-aos='fade-up'>
                <span className='PropertyDetails-heading'>Terms & Conditions</span>
                <div className='col-lg-12 BuilderPDtC-col'>
                    <span className='BuilderPDtC-col_span'>
