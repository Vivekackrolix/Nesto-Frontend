...
import './BrokerPDlocationAdvantage.css'
import BrokerPDlocation from './BrokerPDlocation/BrokerPDlocation'
import Aos from 'aos'
import { useEffect } from 'react'

const BrokerPDlocationAdvantage = () => {
    const data = [
        {
            size: '2110 Sqft',
    ...
    return (
        <>
            <div className='container BrokerPDlocationAdvantage' data-aos='fade-up'>
                <span className='PropertyDetails-heading'>Location Advantages</span>
                <div className='col-lg-12 BrokerPDlocationAdvantage-col_12'>
                    <div className='row'>
                        {data.map((item) => {
                            return (
                                <div className='col-lg-3 col-md-3 col-sm-6 BrokerPDlocationAdvantage-col'>
                                    <img src={item.img} className='BrokerPDlocationAdvantage-col_icon' alt='icon' />
                                    <span className='BrokerPDlocationAdvantage-col_name'>
                                        {item.nearLocation}
                                    </span>
                                    <span className='BrokerPDlocationAdvantage-col_size'>
                                        {item.size}
                                    </span>
                                </div>
                            )
                ...
                <iframe
                    className='BrokerPDlocationAdvantage_map'
                    width='100%'
                    height='340px'
                    data-aos='zoom-in'
                    title='broker-property-location-advantage'
...
export default BrokerPDlocationAdvantage