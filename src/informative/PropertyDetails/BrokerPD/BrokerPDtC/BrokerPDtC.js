...
const BrokerPDtC = () => {
    ...
    return (
        <>
            <div className='container BrokerPDtC' data-aos='fade-up'>
                <span className='PropertyDetails-heading'>Terms & Conditions</span>
                <div className='col-lg-12 BrokerPDtC-col'>
                    <span className='BrokerPDtC-col_span'>
