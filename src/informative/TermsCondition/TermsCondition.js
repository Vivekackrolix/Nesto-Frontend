                ...
                <div className='container t-c_container'>
                    <div className='row'>
                        <div className='col-lg-12'>
                            ...
                            <Fade up duration={1000} delay={100}>
                                <span className='t-c_span'>
                                    When You use any of the services provided by Us through the Platform, You will be subject to the rules, 
                                    guidelines, policies, terms, and conditions applicable to such service, and they shall be deemed to be 
                                    incorporated into this Terms and shall be considered as part and parcel of this Terms.
                                </span>
                            </Fade>
                            <Terms />
                        </div>
