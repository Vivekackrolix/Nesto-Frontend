        ...
        <>
            ...
            <div data-aos='fade-up'>
                ...
                <div className='t-c_box'>
                    ...
                    <div className='d-flex gap-1 align-items-start mt-3'>
                        <span className='t-c_li'>2. </span>
                        <li className='t-c_li'>Find a property through Magicbricks.com and its internet links.</li>
                    </div>
                    <div className='d-flex gap-1 align-items-start mt-3'>
                        <span className='t-c_li'>3. </span>
                        <li className='t-c_li'>Place a print advertisement in any of the group publications through the www.Magicbricks.com site.</li>
                    </div>
                    <div className='d-flex gap-1 align-items-start mt-3'>
                        <span className='t-c_li'>4. </span>
                        <li className='t-c_li'>Post advertisements on Magicbricks.com.</li>
                    </div>
                    <div className='d-flex gap-1 align-items-start mt-3'>
            ...
            <div data-aos='fade-up'>
                ...
                <div className='t-c_box'>
                    ...
                    <div className='d-flex gap-1 align-items-start mt-3'>
                        <span className='t-c_li'>2. </span>
                        <li className='t-c_li'>The User is hereby informed that for all the packages bought prior to December 01, 2019, an option shall be made available to convert balance of the existing listing package, in part or full, to be able to advertise on new PG Platform. Any conversion of the existing package to avail new PG Platform services shall be irreversible and cannot be altered.</li>
                    </div>
                    <div className='d-flex gap-1 align-items-start mt-3'>
                        <span className='t-c_li'>3. </span>
                        <li className='t-c_li'>That the package bought from MB after December 02, 2019 can be used to post regular as well as PG listings on the current Magicbricks Platform only till the launch of the new PG platform. In this case, however, if the User has any portion remaining of his/her/its package, User can use it only in the current Magicbricks platform for listings other than PG. If the User is an agent & deals in PG, the Company recommends, User to buy a separate PG listing package which will be announced shortly.</li>
                    </div>
                    <div className='d-flex gap-1 align-items-start mt-3'>
                        <span className='t-c_li'>4. </span>
                        <li className='t-c_li'>That all PG listings will be visible on the current platform. However, post launch of PG Platform, these listings would be migrated to the new platform and shall be visible till the expiry duration of the listings.</li>
                    </div>
                    <div className='d-flex gap-1 align-items-start mt-3'>
                        <span className='t-c_li'>5. </span>
                        <li className='t-c_li'>That the User, who buys a separate PG pack, hereby agrees that in order to improve genuine listings and have authorised Sellers, the Company mandates the agent(s) posting listings against specific PGs to obtain NOC from the PG owners or Operators.</li>
                    </div>
                    <div className='d-flex gap-1 align-items-start mt-3'>
