    ...
    return (
        <>
            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-lg-12'>
                        <span className='info_span' data-aos='fade-right'>
                            A. Information Supplied By Users
                        </span>
                        <span className='info_span' data-aos='fade-right'>
                            Registration data
                        </span>
                        <span className='info_span2' data-aos='fade-left'>
            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-lg-12'>
                        <span className='info_span' data-aos='fade-left'>
                            Cookies
                        </span>
                        <span className='info_span2' data-aos='fade-right'>
                        ...
                        <span className='info_span mt-4' data-aos='fade-left'>
                            Opting out
                        </span>
                        <span className='info_span2' data-aos='fade-right'>
                        ...
                        <span className='info_span2 mt-4' data-aos='fade-left'>
