...
import Rating from "../personal-details/Rating";
...
const DashboardChildCard = ({ cardType, status, payment }) => {
  ...
  const cardProps = {};
  if (location.pathname === "/builder/home-dashboard/profile") {
    cardProps.as = Link;
    // cardProps.to = `/builder/home-dashboard/property-details-assigned`;
    cardProps.to = `/builder/home-dashboard/profile`;
  }
  return (
    <Card
      {...cardProps}
    ...
    >
      ...
      >
        <Row>
          ...
          {location.pathname === "/builder/home-dashboard/property-details" && (
