...
const RecentlyAdded = ({ data }) => {
  const propertyListing = data.map((itm, index) => {
    return (
      <Col md={3} className="card mb-4 shadow-sm rounded-4 p-0 border-0" style={{ width: "21.75rem" }}>
        ...
        <Card.Body>
          ...
          <Card.Text>
            <Row>
              ...
              <p style={{ opacity: 0.5 }}>Luxury Apartment in Sector-29,Gurugram</p>
              </Col>
              <Col md={2} sm={2}>
                <RiVipCrownFill style={{padding: "5px", borderRadius: "50%", background: "#ffd600", color: "#fff", width: "1.85em", height: "1.85em"}}/>              
              </Col>
            </Row>
            <Row>
            ...
            >
              ...
              <button
                ...
                style={{ color: "#278FD9", fontSize: "14px" }}
              >
                <BsPencilFill style={{width: "0.9em", color: "#fff", background: "#278fd9", padding: "2px", borderRadius: "50%", marginRight: "4px", marginBottom: "5px"}}/>Edit
              </button>
            </div>
          </Card.Text>
        </Card.Body>
